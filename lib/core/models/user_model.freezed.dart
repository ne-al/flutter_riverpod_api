...
class _$UserModelImpl extends _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, username: $username, email: $email, phone: $phone, website: $website, company: $company)';
  }
...
abstract class _UserModel extends UserModel {
  const factory _UserModel(
      ...
      required final CompanyModel company}) = _$UserModelImpl;
